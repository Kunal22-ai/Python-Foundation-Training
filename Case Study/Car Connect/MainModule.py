...
from serviceanddatabase.AdminService import AdminService
...
from serviceanddatabase.ReportGenerator import ReportGenerator
from serviceanddatabase.ReservationService import ReservationService
...
if __name__ == "__main__":
    ...
    try:
        db_connect.connect()  # Connecting to database
        interface = MainModule(db_connect)
        interface.main_menu()
        db_connect.disconnect()  # Disconnect database after exiting
